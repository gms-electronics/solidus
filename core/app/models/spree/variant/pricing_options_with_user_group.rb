    ...
    class PricingOptionsWithUserGroup
      ...
      def self.from_line_item(line_item)
        ...
        new(
          ...
          user_group_id: line_item.order.user.try!(:user_group_id) || line_item.order.store.try!(:default_user_group_id)
        )
      end
      ...
      def self.from_context(context)
        new(
          ...
          user_group_id: context.current_spree_user.try!(:user_group_id).presence || context.current_store.try!(:default_user_group_id).presence
        )
      end
